                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <input value="{{ $data->phone }}" required name="phone" type="number" class="form-control" placeholder="Phone no 1">
                                </div>

                                <div class="form-group col-sm-4">
                                    <label for="" class="text-dark"> <b>Phone No 2</b> </label>
                                    <input value="{{ $data->phone2 }}" name="phone2" type="number" class="form-control" placeholder="Phone no 2">
                                </div>

                                <div class="form-group col-sm-4">
                                    <label for="" class="text-dark"> <b>Email</b> </label>
                                    <input value="{{ $data->email }}" required name="email" type="text" class="form-control" placeholder="Email">
                                </div>
