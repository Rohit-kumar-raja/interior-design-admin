            ...
            <div class="table-responsive py-4">
                <table class="table table-bordered" id="datatable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        @php
                        $user=DB::table('all_users')->find($messages->user_id);
                        @endphp
                            <tr>
                                ...
                                <td><a href="{{ route('messages.status', $messages->id) }}"
                                        class="btn @if ($messages->status == 1) btn-success @endif btn-secondary  btn-sm">
